...
import Business.ConfigureAClass;
import Business.Organisation.Organisation;
import Business.UserAccount.UserAccount;
import Interface.Person.ViewStatusJPanel;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
        ...
        business = ConfigureAClass.configure();
    }
    ...
    private void viewStatusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewStatusButtonActionPerformed
        ...
        String id=countJTextField.getText();
        ViewStatusJPanel vsjp=new ViewStatusJPanel(userProcessContainer, business, id);
        userProcessContainer.add("vsjp",vsjp);
        CardLayout layout=(CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void signUpJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpJButtonActionPerformed
        // TODO add your handling code here:
           ...
           SignUpJPanel signUpJPanel=new SignUpJPanel(userProcessContainer,business);
        userProcessContainer.add("sign",signUpJPanel);
        CardLayout layout=(CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
